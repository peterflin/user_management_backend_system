...
class UserModelTestBase:
    class TestUserModel(unittest.TestCase):

        def test_check_user_exist_by_name_should_success(self):
            self.assertTrue(UserModel().check_user_exist_by_name(**{"username": "asbccc3"}))
        
        def test_check_user_exist_by_name_should_fail(self):
        ...
        def test_check_user_exist_by_id_should_success(self):
            self.assertTrue(UserModel().check_user_exist_by_id(user_id=1))
        
        def test_check_user_exist_by_id_should_fail(self):
...
if __name__ == "__main__":
    ...
    suite.addTest(UserModelTestBase.TestUserModel('test_create_user'))
    suite.addTest(UserModelTestBase.TestUserModel('test_delete_user'))
    suite.addTest(UserModelTestBase.TestUserModel('test_get_password'))
    suite.addTest(UserModelTestBase.TestUserModel('test_check_user_exist_by_id'))
    suite.addTest(UserModelTestBase.TestUserModel('test_check_user_exist_by_name'))
    suite.addTest(UserModelTestBase.TestUserModel('test_update_user_info'))
